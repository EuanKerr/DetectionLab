...
Invoke-Command -computername dc -Credential (new-object pscredential("windomain\bglocaladmin", (ConvertTo-SecureString -AsPlainText -Force -String "P@ssw0rd1"))) -ScriptBlock {
